...
def get_logger(name=None, level="warn"):
    """Get the logger for printing information.
...
def json_serializable(key_path="./", value_path="./"):
    ...
    will be outputted as a key-value pair recursively if there are also attributes
    ...
    class attributes will not be serialized as they are invisible for
    __dict__ attribute.
    ...
    def from_json(self, json_obj):
        ...
        # Get sub-object containing the target key-value pairs according to key_path.
        k_obj = json_obj
        ...
        for key in self.__dict__:
            ...
            if hasattr(self.__dict__[key], "from_json"):
                # Another json-serializable object
...
def aggregate_f0_info(pred, t_unit):
    ...
    agg_f0: list[dict]
        ...
        a single frequency with start time, end time, and frequency
        recorded in *dict*.
    """
    results = []
