...
def audio_bytes_to_np(
    wav_data, sample_rate=DEFAULT_SAMPLE_RATE, normalize_db=0.1, mono=True
):
...
#             audio_files[fname], sample_rate=sample_rate, normalize_db=normalize_db
#         )
